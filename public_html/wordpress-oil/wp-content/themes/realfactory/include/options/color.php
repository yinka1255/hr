	...
	$realfactory_admin_option->add_element(array(
		...
		'options' => array(
			...
			'navigation-menu-color' => array(
				...
				'options' => array(
					...
					'side-menu-text-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#979797',
						'selector'=> 'ul.mm-listview li a{ border-color: #gdlr#; }' .
					...
					'side-menu-text-hover-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector'=> '.mm-navbar .mm-title, .mm-navbar .mm-title:hover, .mm-navbar .mm-btn, .mm-navbar .mm-btn:hover, ' .
							'ul.mm-listview li a:hover, ul.mm-listview li.current-menu-item a, ul.mm-listview li.current-menu-ancestor a{ color: #gdlr#; }'
					),
			...
			'element-4-color' => array(
				'title' => esc_html__('Element P,S,T', 'realfactory'),
				'options' => array(
					...
					'slider-control-navigation-color' => array(
						'title' => esc_html__('Slider Control Navigation Color', 'realfactory'),
						'type' => 'colorpicker',
						'default' => '#8a8a8a',
