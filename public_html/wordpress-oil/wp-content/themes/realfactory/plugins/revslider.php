<?php
	...
	add_filter('revslider_getUsedFonts', 'realfactory_revslider_getUsedFonts');
	if( !function_exists('realfactory_revslider_getUsedFonts') ){
		function realfactory_revslider_getUsedFonts( $used_font ){
