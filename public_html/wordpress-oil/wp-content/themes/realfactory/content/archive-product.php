 ...
 */
	...
	$settings = array(
		'query' => $wp_query,
		'thumbnail-size' => realfactory_get_option('general', 'woocommerce-archive-thumbnail', 'full'),
		'column-size' => realfactory_get_option('general', 'woocommerce-archive-column-size', '20'),
