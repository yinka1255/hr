		...
		<?php
			...
			if( $post_type == 'post' ){
				...
				if( empty($post_option['blog-feature-image']) || $post_option['blog-feature-image'] == 'default' ){
					$feature_image_pos = realfactory_get_option('general', 'default-blog-feature-image', 'content');
				}else{
				...
				if( empty($post_format) ){
					if( $feature_image_pos == 'content' ){
						...
						if( !empty($feature_image) ){
							$thumbnail_size = realfactory_get_option('general', 'blog-thumbnail-size', 'full');
			...
			wp_link_pages( array(
				'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'realfactory' ) . '</span>',
				'after'       => '</div>',
				'link_before' => '<span>',
				'link_after'  => '</span>',
				'pagelink'    => '<span class="screen-reader-text">' . esc_html__( 'Page', 'realfactory' ) . ' </span>%',
