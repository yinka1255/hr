    ...
    if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                $this->upload_dir = ThemegumReduxFramework::$_upload_dir . 'advanced-customizer/';
                $this->upload_url = ThemegumReduxFramework::$_upload_url . 'advanced-customizer/';
                ...
                if ( empty( $this->_extension_dir ) ) {
                    $this->_extension_dir = trailingslashit( str_replace( '\\', '/', get_template_directory().'/redux-framework/ReduxCore/inc/extensions/customizer' ) );
            ...
            function enqueue_controls_css() {
                ...
                include_once( get_template_directory()."/redux-framework/ReduxCore/core/enqueue.php" );
                ...
                wp_enqueue_script(
                    ...
                    $this->_extension_url . 'extension_customizer' . ThemegumRedux_Functions::isMin() . '.js',
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    include_once get_template_directory().'/redux-framework/ReduxCore/inc/extensions/customizer/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    include_once get_template_directory().'/redux-framework/ReduxCore/inc/extensions/customizer/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    include_once get_template_directory().'/redux-framework/ReduxCore/inc/extensions/customizer/inc/customizer_control.php';
                }

                include_once get_template_directory().'/redux-framework/ReduxCore/inc/extensions/customizer/inc/customizer_fields.php';
                include_once get_template_directory().'/redux-framework/ReduxCore/inc/extensions/customizer/inc/customizer_devs.php';
                    ...
                    foreach ( $section['fields'] as $skey => $option ) {
                        ...
                        if ( ! empty( $option['data'] ) && empty( $option['options'] ) ) {
                            ...
                            if ( $option['data'] == "elusive-icons" || $option['data'] == "elusive-icon" || $option['data'] == "elusive" ) {
                                $icons_file = ThemegumReduxFramework::$_dir . 'inc/fields/select/elusive-icons.php';
            ...
            public function _enqueue_previewer() {
                ...
                $localize = array(
                    'save_pending'   => esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'petro' ),
                    'reset_confirm'  => esc_html__( 'Are you sure? Resetting will lose all custom values.', 'petro' ),
                    'preset_confirm' => esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'petro' ),
                        ...
                        foreach ( $section['fields'] as $field ) {
                            if ( isset( $field['type'] ) ) {
                                ...
                                if ( ! class_exists( $field_class ) ) {
                                    $class_file = apply_filters( 'redux-typeclass-load', get_template_directory(). '/redux-framework/ReduxCore/inc/fields/' . $field['type'] . '/field_' . $field['type'] . '.php', $field_class );
                                    if ( $class_file ) {
                                        /** @noinspection PhpIncludeInspection */
                                        require_once( get_template_directory(). '/redux-framework/ReduxCore/inc/fields/' . $field['type'] . '/field_' . $field['type'] . '.php' );
                                    }
                                }
