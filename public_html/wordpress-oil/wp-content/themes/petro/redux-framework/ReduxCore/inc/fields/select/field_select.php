    ...
    class ReduxFramework_select {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                ...
                ThemegumReduxFramework::$_url . 'inc/fields/select/field_select' . ThemegumRedux_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    ...
                    ThemegumReduxFramework::$_url . 'inc/fields/select/field_select.css',
                    array(),
                    time(),
                    'all'
                );
