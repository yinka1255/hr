    ...
    if ( ! class_exists( 'ReduxFramework_options_object' ) ) {
        ...
        class ReduxFramework_options_object {
            ...
            function __construct( $field = array(), $value = '', $parent ) {
                ...
                $this->extension_dir = ThemegumReduxFramework::$_dir . 'inc/extensions/options_object/';
                $this->extension_url = ThemegumReduxFramework::$_url . 'inc/extensions/options_object/';
...
?>                
                <fieldset id="<?php echo $id; ?>" class="redux-field redux-container-<?php echo $this->field['type'] . ' ' . $this->field['class']; ?>" data-id="<?php echo esc_attr($this->field['id']); ?>">
                    <h3><?php esc_html_e( 'Options Object', 'petro' ); ?></h3>
                    <div id="redux-object-browser"></div>
                    <div id="redux-object-json" class="hide"><?php echo $json; ?></div>
                    <a href="#" id="consolePrintObject" class="button"><?php esc_html_e( 'Show Object in Javascript Console Object', 'petro' ); ?></a>
                </div>
                </fieldset>
<?php
                if ( true == $bDoClose ) { ?>
...
<?php
            ...
            public function enqueue() {
                ...
                wp_enqueue_script(
                    ...
                    $this->extension_url . 'options_object/field_options_object' . ThemegumRedux_Functions::isMin() . '.js',
                    array( 'jquery' ),
