    ...
    class ReduxFramework_slider {
        ...
        function enqueue() {
            ...
            wp_enqueue_style(
                ...
                ThemegumReduxFramework::$_url . 'inc/fields/slider/vendor/nouislider/redux.jquery.nouislider.css',
                array(),
                '5.0.0',
                'all'
            );
            ...
            wp_enqueue_script(
                'redux-nouislider-js',
                ThemegumReduxFramework::$_url . 'inc/fields/slider/vendor/nouislider/redux.jquery.nouislider' . $min . '.js',
                array( 'jquery' ),
                '5.0.0',
                true
            );
            ...
            wp_enqueue_script(
                ...
                ThemegumReduxFramework::$_url . 'inc/fields/slider/field_slider' . $min . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    ...
                    ThemegumReduxFramework::$_url . 'inc/fields/slider/field_slider.css',
                    array(),
                    time(),
                    'all'
                );
