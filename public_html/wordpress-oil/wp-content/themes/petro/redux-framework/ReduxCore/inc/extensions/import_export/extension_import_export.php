    ...
    if ( ! class_exists( 'ReduxFramework_extension_import_export' ) ) {
        ...
        class ReduxFramework_extension_import_export {
            ...
            public function __construct( $parent ) {
                ...
                $this->is_field = ThemegumRedux_Helpers::isFieldInUse( $parent, 'import_export' );
            ...
            public function add_section() {
                $this->parent->sections[] = array(
                    'id'         => 'import/export',
                    'title'      => esc_html__( 'Import / Export', 'petro' ),
                    'heading'    => '',
                    'icon'       => 'el el-refresh',
                    'customizer' => false,
                    'fields'     => array(
            ...
            public function overload_field_path( $field ) {
                return get_template_directory().'/redux-framework/ReduxCore/inc/extensions/import_export/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
