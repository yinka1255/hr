    ...
    class ReduxFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                // Process placeholder
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'petro' );
                ...
                if ( '' == $this->value ) {
                    ...
                    echo '<img src=' . esc_url($this->field['options'][ $arrNum - 1 ]['img']) . ' class="redux-preview-image" id="image_' . $this->field['id'] . '">';
                }
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'petro' ) . '</strong>';
            }
        }
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                ...
                ThemegumReduxFramework::$_url . 'inc/fields/select_image/field_select_image' . ThemegumRedux_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    ...
                    ThemegumReduxFramework::$_url . 'inc/fields/select_image/field_select_image.css',
                    array(),
                    time(),
                    'all'
                );
