        ...
        public function enqueue () {
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style (
                    ...
                    ThemegumReduxFramework::$_url . 'inc/fields/checkbox/field_checkbox.css',
                    array(),
                    time (),
                    'all'
                );
            ...
            wp_enqueue_script (
                ...
                ThemegumReduxFramework::$_url . 'inc/fields/checkbox/field_checkbox' . ThemegumRedux_Functions::isMin () . '.js',
