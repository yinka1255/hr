    ...
    if ( ! class_exists( 'ThemegumRedux_Helpers' ) ) {
        ...
        class ThemegumRedux_Helpers {
            ...
            public static function trackingObject() {
                ...
                return ThemegumRedux_Helpers::getTrackingObject();
            }
                    ...
                    foreach ( $files as $file ) {
                        ...
                        if ( $theme_file ) {
                            ...
                            if ( $core_version && ( empty( $theme_version ) || version_compare( $theme_version, $core_version, '<' ) ) ) {
                                ...
                                $found_files[ $plugin_name ][] = sprintf( wp_kses( __( '<code>%s</code> version <strong style="color:red">%s</strong> is out of date. The core version is %s', 'petro' ),array('code'=>array(),'strong'=>array('style'=>array()))), str_replace( WP_CONTENT_DIR . '/themes/', '', $theme_file ), $theme_version ? $theme_version : '-', $core_version );
                            } else {
            ...
            public static function rURL_fix( $base, $opt_name ) {
                ...
                return ThemegumRedux_Functions::tru( $url, $opt_name );
            }
