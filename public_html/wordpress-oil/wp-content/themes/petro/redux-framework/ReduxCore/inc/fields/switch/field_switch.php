...
if ( ! class_exists( 'ReduxFramework_switch' ) ) {
    class ReduxFramework_switch {
        ...
        function render() {
            ...
            //Label ON
            $this->field['on'] = isset( $this->field['on'] ) ? $this->field['on'] : esc_html__( 'On', 'petro' );

            //Label OFF
            $this->field['off'] = isset( $this->field['off'] ) ? $this->field['off'] : esc_html__( 'Off', 'petro' );
        ...
        function enqueue() {
            wp_enqueue_script(
                ...
                ThemegumReduxFramework::$_url . 'inc/fields/switch/field_switch' . ThemegumRedux_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    ...
                    ThemegumReduxFramework::$_url . 'inc/fields/switch/field_switch.css',
                    array(),
                    time(),
                    'all'
                );
