        ...
        class ReduxFramework_ace_editor {
            ...
            public function enqueue() {
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    if ( ! wp_style_is( 'redux-field-ace-editor-css' ) ) {
                        wp_enqueue_style(
                            ...
                            ThemegumReduxFramework::$_url . 'inc/fields/ace_editor/field_ace_editor.css',
                            array(),
                            time(),
                            'all'
                        );
                ...
                if ( ! wp_script_is( 'ace-editor-js' ) ) {
                    wp_enqueue_script(
                        'ace-editor-js',
                        ThemegumReduxFramework::$_url . 'assets/js/vendor/ace_editor/ace.js',
                        array( 'jquery' ),
                        '1.1.9',
                        true
                    );
                ...
                if ( ! wp_script_is( 'redux-field-ace-editor-js' ) ) {
                    wp_enqueue_script(
                        ...
                        ThemegumReduxFramework::$_url . 'inc/fields/ace_editor/field_ace_editor' . ThemegumRedux_Functions::isMin() . '.js',
