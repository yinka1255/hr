    ...
    if ( ! class_exists( 'ReduxFramework_Extension_options_object' ) ) {
        ...
        class ReduxFramework_Extension_options_object {
            ...
            public function __construct( $parent ) {
                ...
                $this->is_field = ThemegumRedux_Helpers::isFieldInUse($parent, 'options_object');
            ...
            public function add_section() {
                $this->parent->sections[] = array(
                    'id' => 'options-object',
                    'title' => esc_html__( 'Options Object', 'petro' ),
                    'heading' => '',
            ...
            public function overload_field_path( $field ) {
                return get_template_directory().'/redux-framework/ReduxCore/inc/extensions/options_object/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
        }
    } 
