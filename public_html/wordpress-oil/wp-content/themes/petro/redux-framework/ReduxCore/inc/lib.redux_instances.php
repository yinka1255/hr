...
defined('ABSPATH') or die();
    /**
     * ThemegumReduxFrameworkInstances Functions
     *
    ...
    if ( ! function_exists( 'get_redux_instance' ) ) {
        ...
        function get_redux_instance( $opt_name ) {
            return ThemegumReduxFrameworkInstances::get_instance( $opt_name );
        }
    }
    ...
    if ( ! function_exists( 'get_all_redux_instances' ) ) {
        ...
        function get_all_redux_instances() {
            return ThemegumReduxFrameworkInstances::get_all_instances();
        }
    }