<?php
    ...
    // Don't duplicate me!
    if ( ! class_exists( 'ThemegumRedux_Admin_Notices' ) ) {
         ...
         * @since       1.0.0
         */
        class ThemegumRedux_Admin_Notices {

            static public $_parent;

            public static function load() {
                add_action( 'wp_ajax_redux_hide_admin_notice', array(
                    'ThemegumRedux_Admin_Notices',
                        ...
                        if ( true == $notice['dismiss'] ) {
                            ...
                            if ( ! get_user_meta( $userid, 'ignore_' . $notice['id'] ) ) {
                                ...
                                if ( version_compare( $wp_version, '4.2', '>' ) ) {
                                    ...
                                    echo '<div ' . $add_style . ' class="' . $notice['type'] . ' notice is-dismissable"><p>' . $notice['msg'] . '&nbsp;&nbsp;<a href="?dismiss=true&amp;id=' . $notice['id'] . $pageName . $curTab . '">' . esc_html__( 'Dismiss', 'petro' ) . '</a>.</p></div>';
                                }
                            }
                        } else {
                            // Standard notice
        ...
        ThemegumRedux_Admin_Notices::load();
    }
