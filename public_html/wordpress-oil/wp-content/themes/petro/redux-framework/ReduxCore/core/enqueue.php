    ...
    if ( ! class_exists( 'reduxCoreEnqueue' ) ) {
        class reduxCoreEnqueue {
            ...
            public function __construct( $parent ) {
                ...
                ThemegumRedux_Functions::$_parent = $parent;
            }

            public function init() {
                $this->min = ThemegumRedux_Functions::isMin();

                $this->timestamp = ThemegumReduxFramework::$_version;
            ...
            private function register_styles() {
                ...
                wp_enqueue_style(
                    'redux-admin-css',
                    ThemegumReduxFramework::$_url . 'assets/css/redux-admin.css',
                    array(),
                    $this->timestamp,
                    'all'
                );
                ...
                if ( ! $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'redux-fields-css',
                        ThemegumReduxFramework::$_url . 'assets/css/redux-fields.css',
                        array(),
                        $this->timestamp,
                        'all'
                    );
                ...
                wp_register_style(
                    'select2-css',
                    ThemegumReduxFramework::$_url . 'assets/css/vendor/select2.css',
                    array(),
                    '3.5.2',
                    'all'
                );
                ...
                wp_register_style(
                    'redux-spectrum-css',
                    ThemegumReduxFramework::$_url . 'assets/css/vendor/spectrum/' . $css_file,
                    array(),
                    '1.3.3',
                    'all'
                );
                ...
                wp_enqueue_style(
                    'redux-elusive-icon',
                    ThemegumReduxFramework::$_url . 'assets/css/vendor/elusive-icons/elusive-icons.css',
                    array(),
                    $this->timestamp,
                    'all'
                );
                ...
                wp_enqueue_style(
                    'qtip-css',
                    ThemegumReduxFramework::$_url . 'assets/css/vendor/qtip/' . $css_file,
                    array(),
                    '2.2.0',
                    'all'
                );
                ...
                wp_enqueue_style(
                    'jquery-ui-css',
                    apply_filters( "redux/page/{$this->parent->args['opt_name']}/enqueue/jquery-ui-css", ThemegumReduxFramework::$_url . 'assets/css/vendor/jquery-ui-bootstrap/jquery-ui-1.10.0.custom.css' ),
                    array(),
                    $this->timestamp,
                    'all'
                );
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    ...
                    wp_register_style(
                        ...
                        ThemegumReduxFramework::$_url . 'assets/css/color-picker/color-picker.css',
                    ...
                    wp_enqueue_style(
                        ...
                        ThemegumReduxFramework::$_url . 'assets/css/media/media.css',
                        array(),
                        time(),
                        'all'
                    );
                ...
                if ( is_rtl() ) {
                    wp_enqueue_style(
                        'redux-rtl-css',
                        ThemegumReduxFramework::$_url . 'assets/css/rtl.css',
            ...
            private function register_scripts() {
                ...
                wp_register_script(
                    ...
                    ThemegumReduxFramework::$_url . 'assets/js/vendor/redux.select2.sortable' . $this->min . '.js',
                    array( 'jquery' ),
                    $this->timestamp,
                    true
                );
                ...
                wp_register_script(
                    'select2-js',
                    ThemegumReduxFramework::$_url . 'assets/js/vendor/select2' . $this->min . '.js',
                ...
                wp_enqueue_script(
                    'qtip-js',
                    ThemegumReduxFramework::$_url . 'assets/js/vendor/qtip/' . $js_file,
                    array( 'jquery' ),
                    '2.2.0',
                    true
                );
                ...
                wp_register_script(
                    'redux-spectrum-js',
                    ThemegumReduxFramework::$_url . 'assets/js/vendor/spectrum/' . $js_file,
                    array( 'jquery' ),
                    '1.3.3',
                    true
                );                
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    wp_register_script(
                        'redux-vendor',
                        ThemegumReduxFramework::$_url . 'assets/js/vendor.min.js',
                        array( 'jquery' ),
                        $this->timestamp,
                        true
                    );
                ...
                wp_register_script(
                    'redux-js',
                    ThemegumReduxFramework::$_url . 'assets/js/redux' . $this->min . '.js',
                    $depArray,
                    $this->timestamp,
                    true
                );
                ...
                wp_enqueue_script(
                    'webfontloader',
                    ThemegumReduxFramework::$_url . 'assets/js/vendor/webfont.js',
                    array( 'jquery' ),
                    '1.5.0',
                    true
                );
            ...
            public function _enqueue_field($field) {
                ...
                if ( isset( $field['type'] ) && $field['type'] != 'callback' ) {
                     ...
                     */
                    $class_file = apply_filters( "redux/{$this->parent->args['opt_name']}/field/class/{$field['type']}", ThemegumReduxFramework::$_dir . "inc/fields/{$field['type']}/field_{$field['type']}.php", $field );
                    if ( $class_file ) {
            ...
            private function set_localized_data() {
                ...
                if ( isset( $this->parent->args['dev_mode'] ) && $this->parent->args['dev_mode'] == true || $this->parent->args['dev_mode'] == false && isset($this->parent->args['forced_dev_mode_off']) && $this->parent->args['forced_dev_mode_off'] == true ) {
                    ...
                    $this->parent->localize_data['rAds'] = ThemegumRedux_Helpers::rURL_fix( $base, $this->parent->args['opt_name'] );
                }
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/save_pending", esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'petro' ) );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset", esc_html__( 'Are you sure? Resetting will lose all custom values.', 'petro' ) );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset_section", esc_html__( 'Are you sure? Resetting will lose all custom values in this section.', 'petro' ) );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/preset", esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'petro' ) );
                global $pagenow;
                $this->parent->localize_data['args'] = array(
                    ...
                    'please_wait'           => esc_html__( 'Please Wait', 'petro' ),
                ...
                $this->parent->localize_data['ajax'] = array(
                    'console' => esc_html__( 'There was an error saving. Here is the result of your action:', 'petro' ),
                    'alert'   => esc_html__( 'There was a problem with your action. Please try again or reload the page.', 'petro' ),
                );
