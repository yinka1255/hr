...
if (!class_exists('ReduxFramework_upload')) {
	...
	class ReduxFramework_upload extends ReduxFramework_extension_upload
	{
		...
		echo '<div class="mfn-upload-field">';
			...
			echo ' <a href="javascript:void(0);" data-choose="Choose a File" data-update="Select File" class="mfn-opts-upload" '. $upload .'><span></span>'. __('Browse', 'consultix') .'</a>';
			echo ' <a href="javascript:void(0);" class="mfn-opts-upload-remove" '. $remove .'>'.__('Remove Upload', 'consultix').'</a>';
