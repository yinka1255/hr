	...
	<!-- wraper_header_main -->
		...
		<div class="container">
			...
			<div class="header_main">
				...
				<!-- brand-logo -->
				<!-- responsive-nav -->
				<div class="responsive-nav hidden-lg hidden-md hidden-sm visible-xs" data-responsive-nav-displace="<?php echo esc_attr( consultix_global_var( 'header_nine_mobile_menu_displace', '', false ) ); ?>">
